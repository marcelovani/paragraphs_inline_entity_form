 ...
 */
class ParagraphsEntityEmbedDialog extends EntityEmbedDialog {
  ...
  public function getFormId() {
    return 'paragraph_entity_embed_dialog';
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state, EditorInterface $editor = NULL, EmbedButtonInterface $embed_button = NULL) {
    ...
    syslog(5, 'DDD E buildForm step ' . @$form_state->get('step'));
    return $form;
  }
  ...
  public function buildSelectStep(array &$form, FormStateInterface $form_state) {
    ...
    //syslog(5, 'DDD E Form entity_id ' . @var_export($form['entity_id'], 1));
    //syslog(5, 'DDD E Form entity_browser ' . @var_export($form['entity_browser'], 1));
    //syslog(5, 'DDD E Form attr ' . @var_export($form['attributes'], 1));
    return $form;
  }
